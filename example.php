...
// Prefer env var; fall back to placeholder
$apiKey = $_ENV['VULTR_API_KEY'] ?? (getenv('VULTR_API_KEY') ?? 'PUT_YOUR_API_KEY_HERE');

// In production: don't pass the 3rd arg (defaults to true = verify TLS)
// In localhost/dev with broken CA store: pass false temporarily
$vultr = new VultrAPI($apiKey, 'https://api.vultr.com/', false); // ⚠️ false ONLY for local testing
